...
public class AvailabilityController {
    ...
    public ResponseEntity<ApiResponse<AvailabilityResponse>> getAvailabilityByLocation(
        ...
        return ResponseEntity.ok(new ApiResponse<AvailabilityResponse>(true, "Available Quantity",new AvailabilityResponse(itemid, locationid,
                availabilityService.calculateAvailabilityByLocation(itemid, locationid))));
    }
    ...
    public ResponseEntity<ApiResponse<AvailabilityResponse>> getAvailabilityByItem(
        ...
        return ResponseEntity.ok(
                new ApiResponse<AvailabilityResponse>(true, "Available Quantity", new AvailabilityResponse(itemid, "NETWORK",
                        availabilityService.calculateAvailabilityByItem(itemid))));
    }
    ...
    public ResponseEntity<ApiResponse<AvailabilityResponseV2V3>> getV2AvailabilityByLocation(
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Available Quantity",
                        availabilityService.calculateV2AvailabilityByLocation(itemid, locationid)));
    }
